#define __NV_MODULE_ID _38_techniqueMegakernel_compute_20_cpp1_ii_4b14c5aa
#define __NV_CUBIN_HANDLE_STORAGE__ extern
#include "crt/host_runtime.h"
#include "techniqueMegakernel.fatbin.c"
static void __nv_cudaEntityRegisterCallback(void **);
static void __sti____cudaRegisterAll_38_techniqueMegakernel_compute_20_cpp1_ii_4b14c5aa(void);
#pragma section(".CRT$XCU",read,write)
__declspec(allocate(".CRT$XCU"))static void (*__dummy_static_init__sti____cudaRegisterAll_38_techniqueMegakernel_compute_20_cpp1_ii_4b14c5aa[])(void) = {__sti____cudaRegisterAll_38_techniqueMegakernel_compute_20_cpp1_ii_4b14c5aa};
...
static void __sti____cudaRegisterAll_38_techniqueMegakernel_compute_20_cpp1_ii_4b14c5aa(void){____cudaRegisterLinkedBinary(__nv_cudaEntityRegisterCallback);}
